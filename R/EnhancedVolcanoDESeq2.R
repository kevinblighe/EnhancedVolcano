EnhancedVolcanoDESeq2 <- function(toptable, AdjustedCutoff = 0.05, LabellingCutoff = 0.05, FCCutoff = 2.0, main = "DESeq2 results", col=c("grey30", "forestgreen", "royalblue", "red2"), DrawConnectors = FALSE)
{
	...
	plot <- ggplot2::ggplot(toptable, ggplot2::aes(x=log2FoldChange, y=-log10(padj))) +
