...
```{r ex1, fig.height = 8, fig.width = 6.5, fig.cap = "Plot the most basic volcano plot."}
...
```{r ex2, fig.height = 8, fig.width = 6.5, fig.cap = "Modify cut-offs for log2FC and P value; add title; adjust point and label size."}
...
```{r ex3, fig.height = 8, fig.width = 6.5, fig.cap = "Adjust colour and alpha for point shading."}
...
```{r ex4, fig.height = 6, fig.width = 7, fig.cap = "Adjust axis limits."}
...
```{r ex5, fig.height = 8, fig.width = 7, fig.cap = "Adjust cut-off lines."}
...
```{r ex6, fig.height = 8, fig.width = 10, fig.cap = "Adjust legend position, size, and text."}
...
```{r ex7, fig.height = 8, fig.width = 6.5, fig.cap = "Plot adjusted p-values."}
...
```{r ex9, fig.height = 8, fig.width = 6.5, fig.cap = "Only label key transcripts."}
...
```{r ex10, fig.height = 8, fig.width = 6.5, fig.cap = "Modify border and remove gridlines"}
...
```{r ex11, fig.height = 8, fig.width = 12, fig.cap = "Plot multiple volcanos on the same page."}
...
In this example, we just wish to colour all transcripts with log2FC > 2 as
'high' and those with log2FC < -2 as 'low'.

```{r ex12, fig.height = 8, fig.width = 12, fig.cap = "Override colour"}
...
In this example we plot the same volcanos as in the previous step; however,
we add an extra level of highlighting key transcripts by shading them.
This feature can be used with or without colOverride = TRUE.

```{r ex13, fig.height = 8, fig.width = 12, fig.cap = "Shade points"}
