...
\description{Publication-ready volcano plots with enhanced colouring
and labeling}
\usage{
EnhancedVolcano(
    toptable,
...
Volcano plots represent a useful way to visualise the results of differential
        expression analyses. Here, we present a highly-configurable function
        that produces publication-ready volcano plots.
}
\value{
