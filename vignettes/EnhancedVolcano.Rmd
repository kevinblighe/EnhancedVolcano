...
```{r ex10, fig.height = 8.5, fig.width = 10, fig.cap = "Over-ride colouring scheme with custom key-value pairs."}
...
```{r ex11, fig.height = 8.5, fig.width = 17, fig.cap = "Over-ride colour and/or shape scheme with custom key-value pairs."}
...
```{r ex12, fig.height = 8.5, fig.width = 10, fig.cap = "Shade certain variables."}
