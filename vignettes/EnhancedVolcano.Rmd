...
with their own colour-scheme, such as colouring transcripts by pathway or
group. This can be achieved by supplying a named vector as colOverride.

In this example, we just wish to colour all transcripts with log2FC > 2 as
'high' and those with log2FC < -2 as 'low'.

```{r ex12, fig.height = 8, fig.width = 11, fig.cap = "Override colour"}
